        ...
        <div className="grid grid-flow-row grid-rows-1 lg:grid-cols-2 md:grid-cols-2">
          ...
          <div>
            ...
            <h3 className="font-semibold  mx-2 mt-4 mb-8 text-md text-slate-400">
              ...
              with computers to my current standing as a web designer, my
              journey has been a dynamic evolution marked by a relentless
            ...
            <h3 className="font-semibold h-2 mx-2 mt-5 mb-8 text-md text-slate-400">
              <div className="flex">
                ...
                <a className="mr-3" href="www.linkdin.com">
                  <svg
                    className="h-5 w-5"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                ...
                <a className="mr-3" href="www.github.com">
                  <svg
                    className="h-5 w-5"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 496 512"
