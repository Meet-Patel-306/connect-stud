          ...
          <div className="p-6">
            ...
            <div className="grid grid-flow-row grid-cols-2 items-center">
              ...
              <h1 className="flex mt-2 text-sm  text-slate-400 leading-relaxed">
                ...
                <p className="m-2">30-6-2006 to 30-5-2006</p>
              </h1>
            </div>
            {/* online and prize */}
            <div className="grid grid-flow-row grid-cols-2 items-center">
            ...
            <div className="flex justify-start items-center m-0">
              <h1 className="flex mt-2 text-sm text-slate-400 leading-relaxed">
                ...
                <p className="m-2">Managed by me</p>
              </h1>
            </div>
            <div className="flex flex-wrap rounded-lg w-full px-4 py-2 mt-0">
              <span className="bg-blue-100 text-blue-800 text-xs font-medium m-1 px-2.5 py-0.5 rounded-lg dark:bg-gray-800 dark:text-blue-400 border border-blue-400">
                Default
              </span>
              <span className="bg-blue-100 text-blue-800 text-xs font-medium m-1 px-2.5 py-0.5 rounded-lg dark:bg-gray-800 dark:text-blue-400 border border-blue-400">
                Default
