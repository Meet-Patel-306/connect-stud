        ...
        <div className="max-w-full flex flex-wrap items-center justify-between p-4">
          ...
          <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <div className="relative">
              <div
                className={`z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 absolute top-0 right-8 ${
            ...
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:borde  r-gray-700">
              ...
              <li>
                <Link
                  ...
                  onClick={() => dispatch(selectHackathon())}
                >
                  Hackathon
                </Link>
              </li>
              <li>
                <Link
                  ...
                  onClick={() => dispatch(selectConnect())}
                >
                  Connect
                </Link>
              </li>
