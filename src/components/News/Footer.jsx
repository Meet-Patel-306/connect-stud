            ...
            <div class="bg-gray-50 dark:bg-gray-800 antialiased">
                <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
                    ...
                    <div class="text-center">
                        ...
                        <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2024-2025 <a href="#" class="hover:underline">ConnectStud™</a>. All Rights Reserved.
                        </span>
                        <ul class="flex justify-center mt-5 space-x-5">
                            ...
                            <li>
                                <a href="https://github.com/MohitPipaliya12/connect-stud/tree/master" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
