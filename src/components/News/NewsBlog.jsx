        ...
        <main class="pt-4 pb-8 lg:pt-8 lg:pb-12 bg-white dark:bg-gray-900 antialiased">
            <div class="flex flex-wrap justify-between items-center px-4 mx-auto max-w-screen-xl">
                <article class="mx-auto w-full max-w-2xl px-4 sm:px-6 lg:px-8 format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                    <header class="mb-4 lg:mb-6 not-format">
                        <address class="flex flex-wrap items-center gap-4 mb-6 not-italic">
                            <div class="flex items-center space-x-4 text-sm text-gray-900 dark:text-white">
                                <img class="w-16 h-16 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-2.jpg" alt="Jese Leos Profile Picture" />
                                <div>
                    ...
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">Flowbite is an open-source library of UI components built with the utility-first
                        classes from Tailwind CSS. It also includes interactive elements such as dropdowns, modals,
                        datepickers.</p>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">Before going digital, you might benefit from scribbling down some ideas in a sketchbook. This way,
                        you can think things through before committing to an actual design project.</p>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">But then I found a <a href="https://flowbite.com">component library based on Tailwind CSS called
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white leading-snug mt-8 mb-4">Getting started with Flowbite</h2>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">First of all you need to understand how Flowbite works. This library is not another framework.
                        Rather, it is a set of components based on Tailwind CSS that you can just copy-paste from the
                        documentation.</p>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">It also includes a JavaScript file that enables interactive components, such as modals, dropdowns,
                        and datepickers which you can optionally include into your project via CDN or NPM.</p>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">You can check out the <a href="https://flowbite.com/docs/getting-started/quickstart/">quickstart
                    ...
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">You'll also receive a lot of useful application UI, marketing UI, and e-commerce pages that can help
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white leading-snug mt-8 mb-4">When does design come in handy?</h2>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">While it might seem like extra work at a first glance, here are some key moments in which prototyping
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-white leading-normal mt-6 mb-3">Laying the Groundwork for Best Design</h3>
                    ...
                    <p class="text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">
                        Let's start by including the CSS file inside the <code class="px-1 py-0.5 bg-gray-100 dark:bg-gray-800 rounded-md">head</code> tag of your HTML.
                    </p>

                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-white leading-normal mt-6 mb-3">Understanding Typography</h3>

                    <h4 class="text-xl font-semibold text-gray-900 dark:text-white leading-snug mt-4 mb-2">Type Properties</h4>
                    <p class="text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">
                    ...
                    <h4 class="text-xl font-semibold text-gray-900 dark:text-white leading-snug mt-4 mb-2">Baseline</h4>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">A typeface is a collection of letters. While each letter is unique, certain shapes are shared across
                        letters. A typeface represents shared patterns across a collection of letters.</p>
                    <h4 class="text-xl font-semibold text-gray-900 dark:text-white leading-snug mt-4 mb-2">Measurement from the baseline</h4>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">A typeface is a collection of letters. While each letter is unique, certain shapes are shared across
                        letters. A typeface represents shared patterns across a collection of letters.</p>
                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-white leading-normal mt-6 mb-3">Type classification</h3>
                    <h4 class="text-xl font-semibold text-gray-900 dark:text-white leading-snug mt-4 mb-2">Serif</h4>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">A serif is a small shape or projection that appears at the beginning or end of a stroke on a letter.
                        Typefaces with serifs are called serif typefaces. Serif fonts are classified as one of the
                        following:</p>
                    <h4 class="text-xl font-semibold text-gray-900 dark:text-white leading-snug mt-4 mb-2">Old-Style serifs</h4>
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-white leading-normal mt-6 mb-3">Laying the best for Successful Prototyping</h3>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">A serif is a small shape or projection that appears at the beginning:</p>
                    <blockquote class="border-l-4 border-gray-300 dark:border-gray-600 pl-4 italic text-gray-700 dark:text-gray-300">
                        <p class="text-lg leading-relaxed">
                            ...
                            login screens to complex dashboards. A perfect choice for your next SaaS application."
                        </p>
                    </blockquote>
                    ...
                    <pre class="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md overflow-scroll">
                        ...
                        &lt;dl class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 
                            ...
                            &lt;div class="flex flex-col justify-center items-center 
                                        p-4 bg-white dark:bg-gray-900 rounded-lg shadow-md"&gt;
                    ...
                    <h4 class="text-xl font-semibold text-gray-900 dark:text-white leading-snug mt-4 mb-2">Table example</h4>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">
                        A serif is a small shape or projection that appears at the beginning or end of a stroke on a letter.
                    </p>
                    ...
                    <table class="min-w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100">
                        <thead class="bg-gray-200 dark:bg-gray-700">
                            <tr>
                                <th class="px-6 py-3 text-left text-sm font-medium uppercase border-b dark:border-gray-600">Country</th>
                                <th class="px-6 py-3 text-left text-sm font-medium uppercase border-b dark:border-gray-600">Date & Time</th>
                                <th class="px-6 py-3 text-left text-sm font-medium uppercase border-b dark:border-gray-600">Amount</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-white leading-normal mt-6 mb-3">Best practices for setting up your prototype</h3>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify"><strong>Low fidelity or high fidelity?</strong> Fidelity refers to how close a prototype will be to
                    ...
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify"><strong>Consider your user</strong>. To create an intuitive user flow, try to think as your user
                        ...
                        path.</p>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify"><strong>Start from the inside out</strong>. A nice way to both organize your tasks and create more
                        ...
                        of your design.</p>
                    <p class="lead text-base text-gray-700 dark:text-gray-300 leading-relaxed text-justify">And there you have it! Everything you need to design and share prototypes — right in Flowbite Figma.
                    </p>
                </article>
            </div>
        </main>
