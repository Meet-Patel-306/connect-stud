        ...
        <div className="grid gap-3 mb-3 grid-cols-2">
          <div>
            ...
            <input
              ...
              placeholder="2023"
              value={startJobYearValue}
              onChange={(e) => setStartJobYearValue(e.target.value)}
            />
          </div>
          <div>
            <label
            ...
            <input
              ...
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="2027"
              value={endJobYearValue}
              onChange={(e) => setEndJobYearValue(e.target.value)}
            />
          </div>
        </div>
        <div className="mt-0">
          ...
          <div>
            ...
            <textarea
              ...
              name="jobInfo"
              id="jobInfo"
              className="block w-full mb-2 px-2 py-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="work as SDE-1 "
              value={jobInfo}
        ...
        <button
          ...
          onClick={(e) => {
            ...
            if (
              ...
              const newJob = {
                startJobYear: startJobYearValue,
                endJobYear: endJobYearValue,
              ...
              if (
                !jobs.some(
                  (job) =>
                    (job.startJobYear == newJob.startJobYear ||
                      job.endJobYear == newJob.endJobYear) &&
                    job.jobInfo == newJob.jobInfo
                )
              ) {
                setJobs((preJob) => [...preJob, newJob]);
              }
              setStartJobYearValue("");
              setCompanyValue("");
              setJobInfo("");
              setEndJobYearValue("");
            }
